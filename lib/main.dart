...
class _EyeotyAppState extends State<EyeotyApp> {
  ...
  void initState() {
    ...
    // reads _authProvider to select the logged-in user's own account by
    // default rather than accounts[0], matching useAccountStore.js.
    _selectedAccountProvider = SelectedAccountProvider(_accountsRepository, _authProvider);
